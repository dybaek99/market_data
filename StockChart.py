...
sql = "SELECT date,open,high,low,close FROM invest.stock_price where date > STR_TO_DATE('20210429', '%Y%m%d') and code = '095500'"
cur.execute(sql)
result = cur.fetchall()
...
for i in range(len(xdate)): xdate[i] = xdate[i][2:] # 2021-01-01 => 20-01-01
